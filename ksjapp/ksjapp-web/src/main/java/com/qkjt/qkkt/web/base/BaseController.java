...
//    }
    ...
    protected HashMap<String, Object> getQueryMap() {
        ...
        pageNum =
                StringUtils.isNotBlank(request.getParameter("pageNum"))
                        && StringUtils.isNumeric(request.getParameter("pageNum")) ? Integer
                        .parseInt(request.getParameter("pageNum")) : pageNum;
        pageSize =
                StringUtils.isNotBlank(request.getParameter("pageSize"))
                        && StringUtils.isNumeric(request.getParameter("pageSize")) ? Integer
